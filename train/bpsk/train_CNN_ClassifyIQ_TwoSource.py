...
x_train, y_train = load_cnn_twosource_data(data_dir, "Train")
x_val, y_val = load_cnn_twosource_data(data_dir, "Val")
...
print(f"Training two-source CNN classifier with rho={rho}...")
...
save_path = os.path.join(save_folder, f"Model_CNN_ClassifyIQ_TwoSource_rho{rho}.h5")
