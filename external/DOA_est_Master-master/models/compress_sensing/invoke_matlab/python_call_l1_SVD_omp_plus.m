function [succ_vec, est_DOA, est_Ps] = python_call_l1_SVD_omp_plus(load_root,save_root,SOURCE_K,snr,M,snap)
% l1_svd is optimized for ULA M=8,k=3,snr=[-20, -15, -10, -5, 0, 5],snap=10
% and min_sep=2, sep_range=(-60,60)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if M==8 && SOURCE_K==3 && snap==10
    threshold_vec = [61,37,19,13,8,5];
    SNR_dB = [-20,-15,-10,-5,0,5];
elseif M==16 && SOURCE_K==3 && snap==10
    threshold_vec = [60,58,30,23,13,10];
    SNR_dB = [-20,-15,-10,-5,0,5];
elseif M==8 && SOURCE_K==7 && snap==10
    threshold_vec = [9,9,5,4,2,1.8];
    SNR_dB = [-20,-15,-10,-5,0,5];
end
idx = SNR_dB == snr;
